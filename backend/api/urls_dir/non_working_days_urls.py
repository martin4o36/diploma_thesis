...
from ..views_dir.non_working_days_views import GetNonWorkingDaysByCountry, AddNonWorkingDay, DeleteNonWorkingDay, EditNonWorkingDay
...
urlpatterns = [
    ...
    path('<int:nwd_id>/edit/', EditNonWorkingDay.as_view(), name='edit_non_working_day'),
]
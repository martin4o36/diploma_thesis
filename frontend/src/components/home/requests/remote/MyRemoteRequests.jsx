...
import { ChevronLeft, ChevronRight, Edit2, Trash2, Calendar, MessageSquare } from "lucide-react";
import api from "../../../../api";
import "../../../../styles/requests/MyRequests.css"
import EditRemoteRequest from "./EditRemoteRequest";

function MyRemoteRequests({ employee }) {
    ...
    const handleCancelRequest = async (requestId) => {
        try {
            await api.put(`/api/request/${requestId}/cancel-remote/`);
            fetchRequests();
        } catch (error) {
                        ...
                        <div className="request-card" key={request.remote_id}>
                            <div className="card-header">
                                ...
                                <div className="card-actions">
                                    ...
                                    <button onClick={() => handleCancelRequest(request.remote_id)}>
                                        <Trash2 />
                                    </button>
                                </div>
                            </div>
...
export default MyRemoteRequests;
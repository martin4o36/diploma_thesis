...
import EditHolidayRequest from "../components/home/requests/EditHolidayRequest"
import api from "../api";
        ...
        return paginatedRequests.map((request, index) => (
            <tr key={index} className="remote-work-request-row">
                ...
                <td className="action-buttons">
                    ...
                    <button className="action-btn delete-btn" onClick={() => handleDeleteRequest(request.request_id)}>
